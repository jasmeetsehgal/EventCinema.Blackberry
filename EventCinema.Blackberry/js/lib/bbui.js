    ...
    createScreenScroller: function (screen) {
        ...
        if (scrollWrapper) {
            ...
            if (bb.device.isPlayBook) {
                var scrollerOptions = {
                    hideScrollbar: true, fadeScrollbar: true, onBeforeScrollStart: function (e) {
                        var target = e.target;
...
_bb10_dropdown = {
    ...
    style: function (select) {
        ...
        // Create our scroller
        dropdown.scroller = new iScroll(scrollArea, {
            vScrollbar: false,
...
_bb_PlayBook_10_scrollPanel = {
    apply: function (elements) {
        ...
        for (i = 0; i < elements.length; i++) {
            ...
            if (bb.device.isPlayBook) {
                outerElement.scroller = new iScroll(outerElement, {
                    vScrollbar: true, hideScrollbar: true, fadeScrollbar: true,
                    onBeforeScrollStart: function (e) {
                        if (bb.scroller) {
                            bb.scroller.disable();
                        }
